        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="{{route('dashboard')}}">
                <!-- Logo icon --><b>
                    ...
                    <!-- Light Logo icon -->
                    <img src="{{ asset('website') }}/asset/images/logo/Cognizant-Logo.png" width="70" height="40" alt="homepage" class="light-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text --><span>
                 <!-- dark Logo text -->
                 ...
                 <!-- Light Logo text -->    
                 {{-- <img src="{{ asset('website') }}/asset/images/logo/Cognizant-Logo.png" width="70" height="40" class="light-logo" alt="homepage" /></span> </a> --}}
                 <img src="{{ asset('website') }}/asset/images/logo/ezgif.com-crop.gif" width="70" height="40" class="light-logo" alt="homepage" /></span> </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        <!-- ============================================================== -->
