                                ...
                                <td>
                                    <div class="btn-group mt-3">
                                        ...
                                        <form action="{{ route('admin.order-edit') }}" method="POST"
                                            ...
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $order->id }}">
                                            <button type="submit" class="btn btn-warning btn-sm m-1" title="Order Edit">
                                        ...
                                        <form action="{{ route('admin.invoice') }}" method="POST"
                                            ...
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $order->id }}">
                                            <button type="submit" class="btn btn-dark btn-sm m-1" title="Order invoice">
                                        ...
                                        {{-- <a href="{{ route('admin.print-invoice',['id'=>$order->id ]) }}" class="btn btn-info">
                                            <i class="bi bi-printer-fill"></i>
                                        </a> --}}
